...
if __name__ == '__main__':
    ...
    tf.config.experimental.set_visible_devices(gpus[3:4], device_type='GPU')
    ...
    model = G6_concat_MDR(data, epoch_num, embedding_size=64, learning_rate=8e-5, reg_loss_ratio=1e-4,
