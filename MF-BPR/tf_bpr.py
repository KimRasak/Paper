...
class BPR():
    ...
    '''
    def __init__(self, data, n_epochs=10, batch_size=32,
                 train_sample_size=10, test_sample_size=50,
    ...
    def split_data(self):
        # groupby = self.data.groupby('userId')['movieId']
        # g_apply = groupby.apply(set)
        # res_index = g_apply.reset_index()
        # res_log = res_index.loc[:,['movieId']]
